...
import com.jarqprog.artGallery.api.config.databaseConfig.DatabaseConfig;
...
@ComponentScan({"com.jarqprog.artGallery.api.config.databaseConfig",
        "com.jarqprog.artGallery.api.dataLogic.components"})
public class Config {
